/*
  This is a utility for taking an neo4j existing managed plugin method
  (using POST) and turning it into an equivalent unmanaged method so
  that it can be invoked using GET, and therefore cached.
*/

package org.opentree.unmanaged;
